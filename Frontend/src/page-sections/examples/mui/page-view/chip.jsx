  ...
  return <ComponentPageLayout title="Chip">
      ...
      <Block title="With Avatar">
        <Stack mb={2} direction="row" flexWrap="wrap" columnGap={3} rowGap={2}>
          ...
          <Chip label="Primary" color="primary" avatar={<Avatar alt="User" src="/static/user/020-man-4.svg" />} />
        ...
        <Stack direction="row" flexWrap="wrap" columnGap={3} rowGap={2}>
          ...
          <Chip variant="outlined" label="Primary" color="primary" avatar={<Avatar alt="User" src="/static/user/020-man-4.svg" />} />
